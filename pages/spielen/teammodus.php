...
<div class="page-grid">
    ...
    <div class="card card-button text-center" onclick="handleClick()">
        <span onclick="loadPage('pages/spielen/teammodus_mitspieler_finden.php')" class="quiz-card-icon"><?php echo $quiz['icon']; ?></span>
        <span onclick="loadPage('pages/spielen/teammodus_mitspieler_finden.php')" class="quiz-card-title"><?php echo htmlspecialchars($quiz['name']); ?></span>
        <span onclick="loadPage('pages/spielen/teammodus_mitspieler_finden.php')" class="quiz-card-info"><?php echo $quiz['questions_count']; ?> Fragen</span>
    </div>
    <?php endforeach; ?>
</div>
